...
export const parentTips = [
  {
    title: '五歲教學：先睇圖，再試，唔識就撳「? 幫我」',
    body: '碩孜唔識答唔會卡住。每題都有圖。撳「? 幫我」會講一句好淺嘅提示；再撳一次有第二句。答錯會自動出圖。答啱就自動去下一題；睇完提示都可以撳箭咀跳過。',
  },
  {
    title: '三步教法（睇 → 試 → 跟）',
    body: '1）睇圖／數點／睇鐘。2）自己試講、揀、拖。3）仲唔識就跟黃色提示讀。數學用橙色十位棒＋圓點，唔使識讀長題目。',
  },
  {
    title: '五歲答題方式：講、揀、拖，唔使打字',
    body: '中英文題請碩孜大聲講（▶）；選擇題先 ▶ 聽再揀；分類用 ＋／－。只有數學用大數字鍵盤。掣面多用符號，方便唔識字。家長幫按 ★。',
  },
  {
